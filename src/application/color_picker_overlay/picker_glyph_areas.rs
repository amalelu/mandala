...
/// `(geometry, section, index)` without allocating a full `GlyphArea`
/// per cell.
///
...
/// drift surfaces there rather than as a silent silent no-op.
struct PickerDynamicContext<'a> {
    geometry: &'a crate::application::color_picker::ColorPickerOverlayGeometry,
    ...
    layout: &'a crate::application::color_picker::ColorPickerLayout,
...
impl<'a> PickerDynamicContext<'a> {
    fn new(
        ...
        use super::color::rgb_to_cosmic_color;
        use crate::application::color_picker::{SAT_CELL_COUNT, VAL_CELL_COUNT};
        use crate::application::widgets::color_picker_widget::load_spec;
        use baumhard::util::color::{hsv_to_hex, hsv_to_rgb};
...
impl<'a> SectionContext for PickerDynamicContext<'a> {
    fn field(
        ...
        section: &str,
        index: usize,
        template: &crate::application::mutator_builder::CellField,
    ) -> baumhard::gfx_structs::area::GlyphAreaField {
        use super::color::{
            highlight_hovered_cell_color, highlight_selected_cell_color, rgb_to_cosmic_color,
        };
        use crate::application::color_picker::{
            arm_bottom_font, hue_slot_to_degrees, sat_cell_to_value, val_cell_to_value, PickerHit,
            CROSSHAIR_CENTER_CELL,
        };
        use crate::application::mutator_builder::CellField;
        use baumhard::core::primitives::ColorFontRegions;
