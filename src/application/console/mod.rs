...
//! Completion is contextual and prefix-matched — no fuzzy scoring and
//! no Tab-to-cycle; the popup updates live as the user types.
//!
//! The command registry is `const COMMANDS: &[Command]`.
//!
//! Module layout:
//!
